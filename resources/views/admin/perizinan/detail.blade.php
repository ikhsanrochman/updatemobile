...
<div class="container-fluid">
    ...
    <div class="card border-0 shadow-sm mb-4">
        ...
        <div class="card-body bg-light">            <div class="d-flex justify-content-end mb-3">
                <a href="{{ route('admin.perizinan.create', ['project_id' => $project->id]) }}" class="btn btn-secondary">
                        ...
                        @forelse($perizinanSumberRadiasiPengion as $index => $izin)
                            <tr>
                                ...
                                <td class="text-center">
                                    <form action="{{ route('admin.perizinan.destroy', $izin->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    <a href="{{ route('admin.perizinan.edit', $izin->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                </td>
                            </tr>
                        @empty
                            <tr>
