        ...
        <div class="card-body">
            ...
            <div class="row mb-3 align-items-center">
                ...
                <div class="col text-end">
                    <a href="{{ route('admin.pemantauan.tld.create', ['projectId' => $project->id]) }}" class="btn btn-primary btn-sm">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="table-responsive w-100" id="tldTableContainer" data-start-year="2021" data-number-of-years="5">
                    <table class="table table-bordered table-hover" id="tldTable">
                        <thead class="table-dark" id="tldTableHeader">
                            <tr>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const tldTableContainer = document.getElementById('tldTableContainer');
        const scrollLeftBtn = document.getElementById('scrollLeftBtn');
        const scrollRightBtn = document.getElementById('scrollRightBtn');
        const tldTableHeader = document.getElementById('tldTableHeader');
        const tldTableBody = document.getElementById('tldTableBody');

        // Initial years setup
        let currentStartYear = parseInt(tldTableContainer.dataset.startYear);
        const numberOfYears = parseInt(tldTableContainer.dataset.numberOfYears);
        ...
        function renderTableYears() {
            ...
            let headerRow = tldTableHeader.querySelector('tr');
            ...
            if (projectUsers.length === 0) {
                ...
                tldTableBody.appendChild(emptyRow);
                return;
            }
            ...
            projectUsers.forEach((user, index) => {
                ...
                for (let year = currentStartYear; year < currentStartYear + numberOfYears; year++) {
                    ...
                    // Access dosis from pre-processed user data
                    let dosisData = '-';
                    // Convert array to year-keyed object in JS
                    const userDosisByYear = user.pemantauanDosisTld.reduce((acc, current) => {
                        acc[current.year] = current;
                        return acc;
                    }, {});
                    if (userDosisByYear[year]) {
                        dosisData = userDosisByYear[year].dosis;
                    }
                    tdDosis.textContent = dosisData;
