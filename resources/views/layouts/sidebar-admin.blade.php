...
<div id="sidebar" class="sidebar d-flex flex-column position-fixed top-0 start-0">
    ...
    <div class="menu-section">
        ...
        <div class="menu-wrap">
            <a href="{{ route('admin.tld.search') }}" class="menu-item {{ Request::is('super-admin/tld*') ? 'active' : '' }}">
                <i class="fas fa-radiation me-2"></i>
                <span>Pemantauan TLD</span>
            </a>
        </div>
        <div class="menu-wrap">
            <a href="{{ route('admin.pendos.search') }}" class="menu-item {{ Request::is('super-admin/pendos*') ? 'active' : '' }}">
                <i class="fas fa-radiation-alt me-2"></i>
