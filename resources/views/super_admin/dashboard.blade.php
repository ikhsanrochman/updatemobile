...
<div class="container-fluid py-4">
    ...
    <div class="row g-3 mb-4">
        <div class="col-6 col-md-3">
            <a href="{{ route('super_admin.kelola_akun') }}" class="text-decoration-none">
        ...
        <div class="col-6 col-md-3">
            <a href="{{ route('super_admin.perizinan.index') }}" class="text-decoration-none">
                <div class="stat-card d-flex align-items-center justify-content-center h-100 p-3" style="background: #0d2c54; color: #fff; border-radius: 15px; min-height: 70px;">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Play notification sound if there is a warning
