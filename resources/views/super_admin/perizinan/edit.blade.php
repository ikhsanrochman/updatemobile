...
<div class="container-fluid px-4">
    ...
    <div class="mb-4 pt-2">
        ...
        <a href="{{ route('super_admin.perizinan.detail', $perizinan->project_id) }}" class="btn btn-secondary">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body bg-light">
            ...
            <div class="row">
                ...
                <!-- Right Column - Form -->
                <div class="col-md-8">
                    <form action="{{ route('super_admin.perizinan.update', $perizinan->id) }}" method="POST">
                        @csrf
                        @method('PUT')
