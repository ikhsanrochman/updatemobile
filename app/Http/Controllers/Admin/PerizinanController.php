...
class PerizinanController extends Controller
{
    public function index()
    {
        ...
        return view('admin.perizinan.index', compact('projects'));
    }

    public function create($project_id)
    {
        $project = Project::findOrFail($project_id);
        return view('admin.perizinan.create', compact('project'));
    }
    ...
    public function detail($id)
    {
        ...
        return view('admin.perizinan.detail', compact('project', 'perizinanSumberRadiasiPengion'));
    }    public function store(Request $request)
    {
        $request->validate([
            ...
            return redirect()
                ->route('admin.perizinan.detail', $perizinan->project_id)
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect()
                ->route('admin.perizinan.detail', $project_id)
